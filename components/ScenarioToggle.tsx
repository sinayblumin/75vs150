...
export function ScenarioToggle({ activeScenario, onScenarioChange }: ScenarioToggleProps) {
    return (
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:p-6">
            <div className="flex flex-col items-center gap-3 md:flex-row md:items-center md:justify-center md:gap-3 lg:gap-4">
                <p className="text-center text-sm font-medium text-slate-800 sm:text-base md:shrink-0 md:whitespace-nowrap md:text-right">
                    בחרו תרחיש להשוואה:
                </p>
