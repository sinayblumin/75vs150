            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <section className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 lg:col-span-1">
                    ...
                    <div className="text-slate-600 leading-relaxed text-sm space-y-4">
                        <p>
                            המודל משווה בין שני תרחישים: פטור עד 75 דולר מול פטור עד 150 דולר, עם הנחות שקופות ומכוילות לסדרי הגודל הרשמיים.
                        </p>
                        <p>
                            ה-KPI מחושבים כך: גביית מע״מ בפועל בכל תרחיש, חיסכון צרכנים ממע״מ ביחס למצב ללא פטור, ואובדן מחזור לעסקים מקומיים.
                        </p>
                        <p>
