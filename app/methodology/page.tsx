                ...
                <section className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 lg:col-span-1">
                    ...
                    <div className="text-slate-600 leading-relaxed text-sm space-y-4">
                        ...
                        <p>
                            ...
                            ומצב רגישות התנהגותי שבו כמות החבילות ברצועת עד 75$ וברצועת 75$-150$ נקבעת כזהה
                            (תוך שמירה על סך חבילות שנתי קבוע), עם שווי ממוצע דומה בין הרצועות להמחשת אפקט כמותי.
                        </p>
